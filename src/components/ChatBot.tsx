...
function answer(q: string): Msg {
  ...
  if (t.includes('open a shop') || t.includes('sell')) return { from: 'bot', text: 'Opening a shop is free with up to 5 listing slots and 7% commission. Seller Pro is UGX 30,000 per 30 days for up to 50 slots and 5% commission. Verification and ads are separate.', links: [{ label: 'Open a shop', to: '/sell' }] }
